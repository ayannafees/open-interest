...
//  * Translates chart timeframes (e.g., '1m', '5m', '1h') into PostgreSQL intervals.
//  */
// const TIMEFRAME_MAP = {
...
//  * ============================================================================
//  * Returns all active contract specifications:
//  * - Symbol (e.g. 'GC Dec27')
//  * - Exchange (COMEX, NYMEX, CME, MX, ICE)
//  * - Tick Size (0.10, 0.01, 0.005)
//  * - Start Price
//  */
...
//  * ============================================================================
//  * Returns the 20-level Order Book Depth snapshot directly from the Exchange matching engine.
//  * Used to initialize the DOM Depth Ladder widget on UI startup.
//  */
...
// /**
//  * ============================================================================
//  * 3. GET /api/market/candles/:instrument
//  * ============================================================================
//  * Returns historical OHLCV candlestick bars using TimescaleDB time_bucket().
//  * Formatted directly for TradingView Lightweight Charts.
//  * Query Parameters:
//  * - ?timeframe=1m (or 1s, 5s, 5m, 15m, 1h, 1d)
//  * - ?limit=100 (Max 500)
//  */
...
//         // TimescaleDB Hypertable Aggregation Query
...
//         // Format timestamps as UNIX seconds for TradingView Lightweight Charts
//         const candles = result.rows.map(row => ({
//             time: Math.floor(new Date(row.bucket).getTime() / 1000), // Epoch seconds
...
// /**
//  * ============================================================================
//  * 4. GET /api/market/tape/:instrument
//  * ============================================================================
//  * Returns the latest 200 executed trades from PostgreSQL / TimescaleDB for
//  * Time & Sales (TAS) Tape widget rehydration.
//  */
